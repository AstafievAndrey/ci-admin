	...
	<div class="row">
	    <div class="col-sm-12">
		<form class="form-horizontal" action="/admin/pages/form_valid_add" method="post">
			...
			<div class="col-sm-6">
				...
				<div class="col-sm-8">
				    <input name="title" id="translit" class="form-control" required type="text" placeholder="*обязательно для заполнения">
				</div>
			    </div>
			    <div class="row m-top">
