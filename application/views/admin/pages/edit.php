	...
	<div class="row">
	    <div class="col-sm-12">
		<form class="form-horizontal" action="/admin/pages/form_valid_edit" method="post">
		    <input name="id" type="hidden" value="<?=$page->id?>"/>
		    <input name="old_translit" type="hidden" value="<?=$page->translit?>"/>
		    <div class="row">
			<div class="col-sm-6">
			    <div class="form-group">
				<label for="seo_title" class="col-sm-4 control-label">сео заголовок</label>
				<div class="col-sm-8">
				    <input name="seo_title" id="seo_title" value="<?=$page->seo_title?>" class="form-control"  required type="text" placeholder="*обязательно для заполнения">
				</div>
			    </div>
			    <div class="form-group">
				<label for="seo_desc" class="col-sm-4 control-label">сео описание</label>
				<div class="col-sm-8">
				    <input name="seo_desc" id="seo_desc" value="<?=$page->seo_desc?>" class="form-control" type="text" placeholder="*необязательно для заполнения">
				</div>
			    </div>
			    <div class="form-group">
				<label for="seo_desc" class="col-sm-4 control-label">транслит</label>
				<div class="col-sm-8">
				    <input name="translit" id="translit" value="<?=$page->translit?>" class="form-control" required type="text" placeholder="*обязательно для заполнения">
				</div>
			    </div>
			    <div class="form-group">
				<label for="title" class="col-sm-4 control-label">заголовок страницы</label>
				<div class="col-sm-8">
				    <input name="title" id="title" value="<?=$page->title?>" class="form-control" required type="text" placeholder="*обязательно для заполнения">
				</div>
			    </div>
			    <div class="form-group">
			...
			<div class="col-sm-offset-1 col-sm-10">
			    <textarea rows="10" name="description" id="description" class="form-control" required type="text" placeholder="*обязательно для заполнения"><?=$page->description?></textarea>
			</div>
		    </div>
		    <div class="form-group">
...
$(".remove-img").on("click",function(){
    ...
    $("#load").show();
    $.ajax({
	url:"/admin/pages/delete_page_file",
	method: "post",
